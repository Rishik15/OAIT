...
const VisionSection = () => {
  return (
    <section
      id="vision"
      className="bg-white py-12 px-6 flex flex-col items-center text-center md:text-left"
    >
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-10">
        ...
        <div className="w-full md:w-1/2 text-[18px] leading-relaxed text-gray-900">
          <p className="border-l-4 border-black pl-4 mb-4">
