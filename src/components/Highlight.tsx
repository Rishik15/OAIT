...
const HighlightsSection = () => {
  return (
    <div className="pt-2 md:pt-6 pb-12 px-6 flex flex-col items-center text-center">
      <p className="max-w-3xl text-[16px] md:text-[18px] leading-relaxed mb-10 px-2">
        Our expertise has already led to pioneering contributions such as:
      </p>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 max-w-6xl w-full">
        {highlights.map((item, index) => (
          ...
          >
            <img
              ...
              loading="lazy"
            />
            <h3 className="text-lg sm:text-xl font-bold mb-3 text-[#E53935]">
              {item.title}
            </h3>
